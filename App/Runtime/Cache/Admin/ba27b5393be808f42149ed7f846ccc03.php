...
<head>
    ...
    var ThinkPHP={
        'pic':'<?php echo U("Admin/Mumber/pic");?>'
    };
  ...
  <div class="tab-pane active" id="home">
     <table class="table table-bordered table-hover definewidth m10" style="margin-top:35px;" >
         ...
         <tr>
            ...
            <td><img src="/webvideo/Public/Admin/Img/23-012515_559.jpg" style="width:140px;height:140px;" id="pic" /></td>
        ...
        <td>
          ...
          <a href="<?php echo U('Admin/Mumber/index');?>" class="btn btn-success ret" >返回列表</a>
        </td>
         </tr>
        </table>
  </div>
...
<script>
var ThinkPHP={
    'index':'<?php echo U("Admin/Mumber/index");?>',
    'addTeacher':'<?php echo U("Admin/Mumber/addTeacher");?>'
};
  $(function () {
